...
from client.jobpost.jobspider.poms import Create
...
def build_pages(page,*,source_excel=None,**args):
    ...
    create = Create(name="create", page=page, data=careerowl_data)
    web_pages = WebPages(pages=[create])
...
def main():
    ...
    Filler().fill(build_pages,arguments)
