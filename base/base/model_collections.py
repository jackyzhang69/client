...
def get_models(rcic_company_id_name: str = "noah", temp_num: int = 1):
    models = {
        ...
        # PR
        "pr-renew": {
            "path": "pr.model.prrenew",
            "class_list": ["PrRenewModel", "PrRenewModelE"],
            "remark": "PR module for form 0008 model",
        },
        "0008": {
            "path": "pr.model.m0008",
            "class_list": ["M0008Model", "M0008ModelE"],
            "remark": "PR Renew module for PR renewal application",
        },
        "0008dp": {
            "path": "pr.model.m0008",
        ...
        "0104": {
            "path": "tr.model.m0104",
            "class_list": ["M0104Model", "M0104ModelE"],
            "pdf_function": "Yes",
            "remark": "TR module for form 0104 model",
        },
        "5645": {
            "path": "tr.model.m5645",
            "class_list": ["M5645Model", "M5645ModelE"],
            "pdf_function": "Yes",
            "remark": "TR module for form 5645 model",
        },
        "1295": {
            "path": "tr.model.m1295",
