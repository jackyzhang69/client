...
class CommonModel(BaseModel):
    ...
    def __init__(
        ...
        *original_excel_objs, new_excel_obj = self._addupExcels(
        ...
        if output_excel_file:
            ...
            self.generateExcel(**data, language=language)
        else:
    ...
    def _generateExcel(self, global_dict, new_excel_obj, excel_file):
        ...
        for k in classes:
            ...
            if "info-" + sheet_table_name in new_excel_obj._sheets.sheet_names:
                sheets.append(
                    new_excel_obj.getSheet(sheet_table_name, variables)
                )  # get sheet object
            if "table-" + sheet_table_name in new_excel_obj._tables.table_names:
                tables.append(
