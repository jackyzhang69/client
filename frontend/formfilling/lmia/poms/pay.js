...
class HoursPay1 extends WebPage {
    ...
    async next() {
        ...
        await this.page.waitForSelector("//label[text()='How many hours will the TFW work each day?']");
    }
}
...
class HoursPay2 extends WebPage {
    ...
    async next() {
        ...
        await this.page.waitForFunction(() => {
            ...
            return elements.some(element => element.textContent.includes('Is your job offer for a full-time position'));
        });
    }
}
